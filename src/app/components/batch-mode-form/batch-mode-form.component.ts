...
@Component({
  selector: 'app-batch-mode-form',
  templateUrl: './batch-mode-form.component.html',
  styleUrls: ['./batch-mode-form.component.scss'],
  animations: [
...
export class BatchModeFormComponent implements OnInit {
  ...
  public readSingleFile(e) {
    ...
    reader.onload = file => {
      ...
      this.form.domain = contents.result;
    };
    reader.readAsText(fileName);
    console.log(reader.readAsText(fileName))
  }

  public readSingleFileDrop(e) {
    let dataTransfer: DataTransfer = e.mouseEvent.dataTransfer;
    if (dataTransfer && dataTransfer.files) {
        let file: File = dataTransfer.files[0];
  ...
  public readSingleFileDropEnter(e){
    console.log(e);
  }
}
